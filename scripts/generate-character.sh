...
EXPR_VARIANTS=(
  ...
  "embarrassed|averted gaze looking down, fidgeting hands, slightly hunched shoulders, shy uneasy expression, manga style embarrassment|looking away shyly, fingers touching together, furrowed brows, bashful awkward expression, manga style sheepishness|eyes darting to the side, hand behind head, uneasy smile, nervous sweat drop, flustered manga style"
  ...
  "determined|sharp focused eyes, tightly clenched fist, firm set jaw, intense concentrated gaze, manga style resolve|narrowed confident eyes, slight forward lean, strong steady gaze, unwavering manga determination|bright clear eyes with small sparkle highlights, clenched teeth showing, bold confident expression, heroic manga fighting spirit"
)
