...
テストプレイ(例:15日まで)を命じられたときは、何も考えずに演出スキップでリロードして、ゲームプレイヤーの立場で15日までプレイし、感想を提出してください。デバッグパネルは使わないでください。15日まで必ずプレイしてください。「クリックがたくさんいる」とか「通知がうざい」とかは人間は無視できるので挙げなくていいです。
