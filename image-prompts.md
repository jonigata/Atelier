...
**スタイルプロンプト**: `cartoon game style, cheerful colors, sticker-style dark outline, clean vector look, game UI icon`
...
| 種別 | プロンプト |
|------|----------|
| deliver | `A simple delivery box icon, cartoon game style, round wooden crate with lid slightly open, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
| quality | `A quality star icon, cartoon game style, shiny golden star with sparkles around it, premium quality badge look, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
| bulk | `A bulk order icon, cartoon game style, stack of multiple wooden crates piled up, pile of boxes, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
...
| カテゴリ | プロンプト |
|---------|----------|
| tutorial | `A tutorial book icon, cartoon game style, open book with glowing pages and question mark, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
| alchemy | `An alchemy cauldron icon, cartoon game style, bubbling purple potion in a black cauldron with magical sparkles, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
| quest | `A quest scroll icon, cartoon game style, rolled parchment scroll with red wax seal, cheerful colors, sticker-style dark outline, clean vector look, game UI icon` |
