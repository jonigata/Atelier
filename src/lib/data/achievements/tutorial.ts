...
export const tutorialAchievements: Record<string, AchievementDef> = {
  ...
  ach_first_complete: {
    ...
    hint: '<strong>依頼を達成</strong>して納品しよう',
    category: 'tutorial',
  ...
  ach_inspection_intro: {
    ...
    narrativeLines: [
      ...
      { text: 'ああ、君がここの担当か。僕はヴィクト、隣村に派遣された錬金術師だ', speaker: 'ヴィクト', speakerTitle: 'ライバル錬金術師', faceId: 'vict', expression: 'neutral' },
      { text: 'イリーナ先生の弟子だって？ ふうん……まぁ、お互い頑張ろうじゃないか', speaker: 'ヴィクト', speakerTitle: 'ライバル錬金術師', faceId: 'vict', expression: 'neutral' },
      { text: 'もっとも、僕はもう工房の整備も終わってるけどね', speaker: 'ヴィクト', speakerTitle: 'ライバル錬金術師', faceId: 'vict', expression: 'smug' },
      { text: '次の査察で会おう。……楽しみにしてるよ', speaker: 'ヴィクト', speakerTitle: 'ライバル錬金術師', faceId: 'vict', expression: 'neutral' },
    ],
    conditions: [],
    reward: {},
    priority: 42,
  ...
  ach_q1_goal_reminder: {
    ...
    narrativeCharacter: { name: 'コレット', title: '駆け出し錬金術師' },
    narrativeLines: [
      '28日目までに、アルバムに13種類以上登録して……',
      'それと依頼を13件以上。……がんばらなくちゃ',
    ],
    conditions: [],
    reward: {},
    priority: 44,
