...
export const milestoneAchievements: Record<string, AchievementDef> = {
  ...
  ach_craft_100: {
    ...
    reward: { money: 1000, reputationExp: 15 },
    priority: 130,
  ...
  ach_craft_elixir: {
    ...
    reward: { money: 1000, reputationExp: 20 },
    priority: 160,
  },
  ...
  ach_quest_30: {
    ...
    reward: { money: 1500, reputationExp: 15 },
    priority: 230,
  ...
  ach_quest_streak_10: {
    ...
    reward: { money: 1000, reputationExp: 10 },
    priority: 250,
  ...
  ach_money_50000: {
    ...
    reward: { money: 2000, reputationExp: 15 },
    priority: 430,
