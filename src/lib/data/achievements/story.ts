...
export const storyAchievements: Record<string, AchievementDef> = {
  ...
  ach_story_report_notice: {
    ...
    hint: '<strong>3月末</strong>の査察に備えよう',
    category: 'quest',
  ...
  ach_story_smith_repair: {
    ...
    reward: {
      items: [{ itemId: 'ore_01', quality: 65, quantity: 3 }],
      originLabel: 'ゴルドが鍛冶場から分けてくれた',
    },
  ...
  ach_story_neighbor_pressure: {
    ...
    hint: '村発展<strong>レベル9</strong>を目指そう',
    category: 'quest',
    narrative: 'client_gratitude',
    narrativeCharacter: { name: 'メルダ', title: 'よろず屋のおばちゃん' },
    narrativeLines: [
    ...
    conditions: [
      ...
      { type: 'village_development', target: 9 },
    ],
    reward: {
      reputationExp: 3,
    },
  ...
  ach_story_q2_checkpoint: {
    ...
    hint: '<strong>依頼10件</strong>・<strong>レベル15</strong>を達成しよう',
    category: 'quest',
    narrative: 'patron_support',
    narrativeCharacter: { name: '査察官', title: '師匠組合' },
    narrativeLines: [
  ...
  ach_story_specialty_start: {
    ...
    hint: '<strong>レベル24</strong>・<strong>調合40回</strong>を達成しよう',
    category: 'alchemy',
    narrative: 'village_girl',
    narrativeCharacter: { name: 'リーネ', title: '村娘' },
    narrativeLines: [
  ...
  ach_story_village_crisis: {
    ...
    hint: '<strong>レベル30</strong>・<strong>品質60</strong>を達成しよう',
    category: 'quest',
  ...
  ach_story_q3_checkpoint: {
    ...
    hint: '<strong>レベル24</strong>・<strong>依頼20件</strong>を達成しよう',
    category: 'quest',
    narrative: 'patron_support',
    narrativeCharacter: { name: '査察官', title: '師匠組合' },
    narrativeLines: [
  ...
  ach_story_specialty_complete: {
    ...
    hint: '<strong>レベル30</strong>・<strong>品質80</strong>・<strong>調合80回</strong>を達成しよう',
    category: 'alchemy',
    narrative: 'workshop_discovery',
    narrativeLines: [
      '長い試行錯誤の末……ついに、完成した',
  ...
  ach_story_girl_friendship: {
    ...
    hint: '名声<strong>レベル18</strong>に到達しよう',
    category: 'quest',
    narrative: 'village_girl',
    narrativeCharacter: { name: 'リーネ', title: '村娘' },
    narrativeLines: [
