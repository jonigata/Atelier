import type { VillageFacilityDef } from '$lib/models/types';

export const villageFacilities: Record<string, VillageFacilityDef> = {
  // =====================================
  // 採取・素材系
  // =====================================
  herb_garden: {
...
export function getVillageFacility(id: string): VillageFacilityDef | undefined {
  return villageFacilities[id];
}

export function getAllVillageFacilities(): VillageFacilityDef[] {
  return Object.values(villageFacilities);
}
