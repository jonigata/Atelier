...
export const achievements: Record<string, AchievementDef> = {
  ...
  ach_first_recipe: {
    ...
    narrativeMessage:
      '師匠からの手紙「レシピを覚えたようだな。これは餞別だ。役立ててくれ」',
  ...
  ach_first_craft: {
    ...
    narrativeMessage: '師匠から調合成功の祝いとして少額の仕送りが届いた',
  ...
  ach_first_quest: {
    ...
    narrativeMessage: '村人「頑張ってくれよ。これ、畑で採れたやつだ」',
  ...
  ach_craft_10: {
    ...
    narrativeMessage: '村長「腕を上げたな。村の者も頼りにしているぞ」',
  ...
  ach_craft_50: {
    ...
    category: 'alchemy',
    narrative: 'village_growth',
    narrativeMessage: '村の評判が近隣にも広まり始めた',
  ...
  ach_craft_100: {
    ...
    category: 'alchemy',
    narrative: 'master_teaching',
    narrativeMessage: '師匠からの手紙「一人前になったようだな。誇りに思う」',
  ...
  ach_quality_90: {
    ...
    narrativeMessage: '匿名の支援者「素晴らしい腕前です。これからも期待しています」',
  ...
  ach_craft_elixir: {
    ...
    narrativeMessage: '工房の奥から前の住人が残した日記を発見した。そこには錬金術の奥義が記されていた...',
  ...
  ach_quest_5: {
    ...
    category: 'quest',
    narrative: 'villager_gift',
    narrativeMessage: '村人たちから感謝の品が届いた',
  ...
  ach_quest_15: {
    ...
    narrativeMessage: '収穫祭で村長から功労者として表彰された',
  ...
  ach_quest_30: {
    ...
    category: 'quest',
    narrative: 'client_gratitude',
    narrativeMessage: 'いつも依頼してくれる村人から特別な謝礼が届いた',
  ...
  ach_quest_streak_5: {
    ...
    category: 'quest',
    narrative: 'patron_support',
    narrativeMessage: '支援者「確実な仕事ぶりに感銘を受けました」',
  ...
  ach_quest_streak_10: {
    ...
    narrativeMessage: '師匠からの手紙「噂は聞いている。流石は私の弟子だ」',
  ...
  ach_expedition_15: {
    ...
    category: 'expedition',
    narrative: 'village_growth',
    narrativeMessage: '採取隊との連携が村の評判を高めている',
  ...
  ach_money_20000: {
    ...
    category: 'economy',
    narrative: 'patron_support',
    narrativeMessage: '支援者「経営手腕を高く評価しています」',
  ...
  ach_money_50000: {
    ...
    category: 'economy',
    narrative: 'village_festival',
    narrativeMessage: '村の発展への貢献が表彰された',
  ...
  ach_sales_10000: {
    ...
    narrativeMessage: 'カリン「いいお客さんね。これからもよろしく」',
  ...
  ach_level_5: {
    ...
    category: 'mastery',
    narrative: 'master_gift',
    narrativeMessage: '師匠から成長を祝う仕送りが届いた',
  ...
  ach_level_10: {
    ...
    category: 'mastery',
    narrative: 'master_teaching',
    narrativeMessage: '師匠からの手紙「一人前と認めよう。これからも精進せよ」',
  ...
  ach_level_15: {
    ...
    narrativeMessage: 'オルト「もう立派な錬金術士だな。アルベルトも喜んでいるだろう」',
  ...
  ach_level_20: {
    ...
    category: 'mastery',
    narrative: 'master_teaching',
    narrativeMessage: '師匠からの手紙「お前はもう私を超えた。誇りに思う」',
  ...
  ach_reputation_50: {
    ...
    category: 'mastery',
    narrative: 'village_festival',
    narrativeMessage: '村の祭りで名誉村民に選出された',
  ...
  ach_reputation_80: {
    ...
    category: 'mastery',
    narrative: 'village_festival',
    narrativeMessage: '年末の祭りで最優秀貢献者として表彰された',
