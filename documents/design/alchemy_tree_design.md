...
| herbal_paste | ハルマム草ペースト | 1 | 1 | ハルマム草×3 | 40 | 軟膏の基材 |
...
| dried_herbs | 乾燥ハルマム草 | 2 | 1 | ハルマム草×2 | 25 | 保存用ハルマム草 |
...
| basic_catalyst | 基礎触媒 | 3 | 1 | ハルマム草×2, 清水×1 | 45 | 錬金の促進剤 |
...
| healing_salve | 傷薬軟膏 | 4 | 1 | ハルマム草ペースト×1, 蜂蜜シロップ×1 | 90 | 外傷治療 |
...
| sound_crystal | こだまの結晶 | 13 | 3 | 純水晶×2, 精霊エッセンス×2 | 800 | 音を伝える結晶 |
...
| life_core | 魂宿りの核 | 14 | 4 | ヴィータエッセンス×2, 結晶核×1 | 1300 | 生命力を宿す核 |
| communication_crystal | 遠音の結晶 | 14 | 3 | こだまの結晶×1, アルカナ回路×1 | 1150 | 遠距離通信用結晶 |
...
| eternal_lamp | 消えずの灯 | 15 | 3 | 光核×2, 銀細工枠×1 | 1500 | ルクス・エテルナの光源部 | 家庭用照明 |
| water_pump | 魔法水ポンプ | 15 | 3 | 柔軟管×3, アルカナ回路×1 | 1300 | 水を汲み上げる装置 | 井戸改良 |
| healing_incense | 治癒の香 | 15 | 4 | 精霊花×3, 蓮の花×2, 聖水×2 | 1600 | 癒しの香り | 病気予防 |
| golem_core | ゴーレムコア | 15 | 4 | ホムンクルス粘土×2, 魂宿りの核×1 | 2000 | ゴーレムの核 | 小型ゴーレム |
...
| clock_mechanism | 刻律の歯車 | 15 | 4 | 精密工具×2, 月光結晶×1, 金インゴット×1 | 1800 | 正確な時を刻む | 家庭用時計 |
| communication_pair | 遠音の双鏡 | 15 | 4 | 魔法鏡×2, 遠音の結晶×2 | 2400 | 対で通信可能 | 2地点間通話 |
...
| bell_mechanism | 鐘機構 | 16 | 4 | 鐘青銅×2, 刻律の歯車×1 | 2800 | 自動で鳴る鐘 | 時報装置 |
| advanced_golem_core | 上級ゴーレムコア | 16 | 5 | ゴーレムコア×2, ドラコニス合金×1 | 5000 | 高性能ゴーレム核 | 作業ゴーレム |
| life_support | アニマの灯台 | 16 | 4 | 魂宿りの核×2, 治癒の香×1 | 3200 | 命を守る装置 | 重病治療 |
...
| healing_censer | パナケイアの香炉 | 17 | 5 | 治癒の香×3, アニマの灯台×1, 金インゴット×2 | 7000 | +8（医療施設） |
| far_mirror | 遠話の鏡 | 17 | 4 | 遠音の双鏡×1, 魔法レンズ×2, 銀細工枠×2 | 6000 | +7（通信インフラ） |
| eternal_light | ルクス・エテルナ | 18 | 5 | アタノールの炉心×1, 消えずの灯×3, 強化ガラス×4 | 12000 | +10（照明インフラ） |
...
| harvest_golem | 豊穣のゴーレム核 | 20 | 7 | アタノールの炉心×1, 上級ゴーレムコア×2, 魂宿りの核×2 | 15000 | +12（農業革命） |
...
| Lv15-16 | 治癒の香、ゴーレムコア、刻律の歯車 | 特別な依頼 |
